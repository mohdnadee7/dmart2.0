        ...
        <>
            ...
            >
                <Text style={{ color: "#000", fontWeight: 600 }}>
                    ...
                    Ensure kitchen cleanliness and sefety
                </Text>

                <Text style={{ color: "#000", backgroundColor: "lightgrey", paddingHorizontal: 10, paddingVertical: 5, borderRadius: 5 }}>
                    <Link href={`/details?description=${encodeURIComponent('Ensure kitchen cleanliness and safety')}`}>
                        View all
                    </Link>
                </Text>
